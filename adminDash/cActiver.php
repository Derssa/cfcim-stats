    ...
    <div class="app">
      ...
      <div class="comptes">
          <div>
            ...
            <a style="color: #000;background-color:#ebe54b;padding:5px 10px;font-weight:500;box-shadow: 0 3px 8px 2px rgba(0, 0, 0, 0.3);border-radius:5px;margin:0 5px;" href="#">Compte activé</a>
          ...
          <?php
            include '../php/db.php'; 
            $sql = "SELECT id,email FROM users WHERE type>=2";
            ...
            if ($result->num_rows > 0) {
              ...
              while($row = $result->fetch_assoc()) {
                  ...
                  <div>
                      <a style="color: #fff;background-color:#0c4377;padding:5px 10px;font-weight:500;box-shadow: 0 3px 8px 2px rgba(0, 0, 0, 0.3);border-radius:5px;margin:0 10px;" href="./modifyAccount.php?id='.$row["id"].'">Modifier</a>
